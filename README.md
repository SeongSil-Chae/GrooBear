...
# 🧩 프로젝트 최종 회고 – GrooBear 그룹웨어

본 회고는 GrooBear 프로젝트를 진행하며 얻은 기술적 성장, 협업 경험, 개선점, 개인적 성찰을 간결하게 정리한 내용입니다.

---

## ✅ 기술적으로 성장한 부분

처음에는 단순 CRUD만 구현할 수 있었지만, 이번 프로젝트를 통해  
**Ajax 기반 다단계 입력, Gantt 차트 시각화, Kanban 상태 관리, 인터페이스 기반 VO 분리 설계** 등  
구조적 사고와 실무형 기술을 자연스럽게 익힐 수 있었습니다.

---

## 🤝 협업에서 배운 점

프로젝트는 혼자 구성했지만, 공통 기능(엑셀 다운로드 등)을 직접 구현해  
팀원들과 **Notion으로 문서화된 모듈을 공유**하고, 사용법을 설명하며 협업하는 경험을 했습니다.  
또한 GitHub를 사용해 버전 관리를 습관화하면서, **코드를 나누고 기록하는 개발자의 태도**를 체득할 수 있었습니다.

---

## 🛠️ 개선하고 싶은 점

기능 개발에 집중하느라 **에러 메시지 처리와 예외 상황 UI 안내가 부족했던 부분**,  
**중복된 자바스크립트 코드의 모듈화 부족**,  
프론트 구조를 관리하는 **상태 관리 코드의 캡슐화**가 아쉬웠습니다.  
다음 프로젝트에서는 기능 외에도 **코드의 정리된 구조와 사용자 경험의 디테일**까지 함께 챙기고 싶습니다.

---

## 🌱 개인적인 성장

이전까지는 "기획자가 개발을 배우는 느낌"이었다면,  
이번 프로젝트를 통해 **직접 설계하고 주도적으로 구현하는 진짜 개발자 경험**을 할 수 있었습니다.  
특히 문제를 분석하고 구조적으로 해결하는 과정에서 **내가 만들 수 있다는 자신감**을 갖게 되었고,  
앞으로도 계속 기술과 책임감을 함께 키워가는 개발자가 되고 싶다는 확신을 얻었습니다.

---

> 실력보다는 **진짜 기능을 끝까지 만들고**,  
> 문서화하고, 공유하고, 팀을 배려했던 과정이 제게 가장 큰 성장이었습니다.
